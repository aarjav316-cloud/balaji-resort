import poolImg from "../assets/rooftoppool/rooftoppool.avif";
  ...
  return (
    ...
    >
      <div className="w-full mx-auto max-w-[1500px]">
        ...
        >
          {/* Static Image Strategy: Restored to standard 100% height since parallax scrub is removed. Hover scale remains. */}
          <img 
            src={poolImg}
          ...
          >
            <div className="max-w-[800px] flex flex-col items-center">
              ...
              >
                Relax above the city with breathtaking panoramic views, a serene infinity pool, and an atmosphere crafted for unforgettable moments. Whether at sunrise or beneath the evening sky, every visit offers peace, comfort, and refined luxury.
              </p>
